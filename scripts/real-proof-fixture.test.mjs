...
for (const filename of ['sepolia-lock-2026-09-05.json', 'creditcoin-executed-2026-09-05.json']) {
  test(`${filename} preserves native tuple, query, successful receipt, lock fact and 50% limit`, async () => {
    const fixture = JSON.parse(
      await readFile(new URL(`../fixtures/proofs/${filename}`, import.meta.url), 'utf8')
    );
