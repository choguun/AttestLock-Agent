...
This is an internal equal-weight planning model of five AMA pillars, not organizer scoring or a prediction of winning. Audit baseline: clean main `002546f`, September 5, 2026. September 10 update: two native lines, September 9 Chrome/Rabby onboarding and refresh recovery, prior borrower draw, and the dated release observations in LIVE_UI_AUDIT. Local hardening and a narrated slide overview do not automatically earn live-delivery points.

| Pillar                       |   Baseline | Evidence-adjusted now |     Target | Basis and remaining gap                                                                                                                       |
| ---------------------------- | ---------: | --------------------: | ---------: | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Userbase Expansion           |         13 |                    14 |         16 | Live app, aggregate endpoint and real browser onboarding; no independent users or adoption validation                                         |
...
| Execution Capability         |         16 |                    18 |         20 | Green CI, hosting, browser onboarding/draw, native proof and negative receipts; maturity, final recordings and operational drills still gated |
